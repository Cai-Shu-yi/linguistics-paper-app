...
const API_BASE = (typeof window !== 'undefined' && window.location.hostname === 'localhost')
  ...
  : 'https://linguistics-paper-app-production.up.railway.app/api';
...
const AI_PROMPT_TEMPLATE = `你是一位资深语言学研究者，请对以下论文进行专业、深入的学术分析。用中文回复，结构清晰，每个部分请详细论述。
...
请按以下五个维度进行深入分析（每个维度400-600字，请提供具体的理论框架、关键术语和核心论点）：

## 研究摘要
用清晰的中文概括论文的研究背景、研究问题、核心方法和主要发现。说明该研究在所属领域中的学术定位。

## 方法论
详细分析研究设计：包括研究对象/被试/语料来源、数据收集流程、分析框架或统计方法。评价其方法论优势和局限。

## 创新点
指出该研究的理论创新、方法创新或实证贡献。与已有研究对比，说明其推进了哪些学术讨论。

## 文献综述要点
梳理论文引用的核心理论框架和关键文献。说明作者如何在前人研究基础上提出研究问题，指出文献中的争议或空白。

## 后续研究方向
基于本文的发现与局限，推测未来可以延伸的2-3个具体研究方向。说明每个方向的研究价值和可行路径。

请严格按照以下JSON格式回复（不要包含代码块标记，不要有markdown格式）：
{
  "summary": "...",
  "methodology": "...",
  "innovation": "...",
